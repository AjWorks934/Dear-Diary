...
<%
   ...
   String username = (String) session.getAttribute("username");
    ...
    // Get entries from session or create new list
    List<Map<String, String>> entries = (List<Map<String, String>>) session.getAttribute("diaryEntries");
    if (entries == null) {
        entries = new ArrayList<>();
        
        // Add sample entry only once when entries list is first created
        Map<String, String> entry3 = new HashMap<>();
        entry3.put("id", "3");
        entry3.put("title", "Weekend Adventures");
        entry3.put("content", "Had an amazing weekend with friends. We went hiking in the mountains and the view from the top was absolutely breathtaking. Sometimes you need to step away from routine to remember what truly matters.");
        entry3.put("date", "2024-05-15");
        entry3.put("mood", "Excited");
        entries.add(entry3);
